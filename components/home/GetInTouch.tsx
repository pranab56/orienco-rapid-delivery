...
const GetInTouch = () => {
  return (
    <section className="w-full container mx-auto px-4 py-20 overflow-hidden">
      <div className="relative w-full bg-[#EB5500] rounded-3xl overflow-hidden min-h-[400px] md:min-h-[500px] flex items-center p-6 md:p-24 shadow-[0_40px_100px_-20px_rgba(235,85,0,0.3)] border border-white/10">
