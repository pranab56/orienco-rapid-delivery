...
export default function PrivacySecurityPage() {
    return (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="pb-20 px-4 md:px-0 max-w-3xl">
            <h2 className="text-2xl md:text-[28px] font-medium text-gray-800 mb-6 md:mb-8 tracking-tight">Privacy Policy</h2>

            <div className="text-[12px] text-[#333333] space-y-6 leading-relaxed bg-[#EBEBEB]/80 font-medium  md:p-8 rounded-xl">
