        ...
        <div className="bg-[#EAEAEA] min-h-screen">
            ...
            <div className="container mx-auto px-4 lg:px-10 pt-16 md:pt-24 shrink-0">
                <div className="mx-auto bg-[#F6F6F6] rounded-xl shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-white p-2.5 overflow-hidden flex flex-col lg:flex-row min-h-[750px]">
                    ...
                    <div className="relative w-full lg:w-[45%] bg-gradient-to-br from-[#EFEBE9] to-[#F1D7CB] rounded-xl p-10 md:p-14 overflow-hidden flex flex-col justify-between group cursor-default">
                        {/* Background Decorative Graphic Circles */}
                        <div className="absolute -bottom-24 -right-24 w-[350px] h-[350px] rounded-full bg-white/20 blur-3xl z-0" />
                        <div className="absolute -bottom-40 -right-10 w-[500px] h-[500px] rounded-full border-[50px] border-white/10 z-0 transition-transform duration-1000 group-hover:scale-105" />
                        <div className="absolute top-[50%] right-[-15%] w-[250px] h-[250px] rounded-full border-[24px] border-white/10 z-0 transition-transform duration-1000 group-hover:-rotate-12" />
                        ...
                        {/* List Array Info */}
                        <div className="relative z-10 space-y-12 mt-16 md:mt-24 mb-24 text-gray-800">
                            <div className="flex items-center gap-6 group/item cursor-pointer">
                                ...
                                <span className="font-medium text-[15px]">+1012 3456 789</span>
                            </div>
                            <div className="flex items-center gap-6 group/item cursor-pointer">
                                <Mail className="text-gray-900 group-hover/item:text-[#EB5500] transition-colors" size={20} />
                                <span className="font-medium text-[15px]">demo@gmail.com</span>
                            </div>
                            <div className="flex items-start gap-6 group/item cursor-pointer">
                                ...
                                <span className="font-medium text-[15px] leading-relaxed max-w-[250px]">
                        ...
                        <div className="relative z-10 flex gap-5 mt-auto">
                            <a href="#" className="w-[42px] h-[42px] rounded-full bg-black flex items-center justify-center text-white hover:bg-[#EB5500] hover:scale-110 transition-all duration-300 shadow-xl shadow-black/10">
                    ...
                    <div className="w-full lg:w-[55%] p-10 md:p-16 lg:pr-20 xl:pr-28">
                        <form onSubmit={handleSubmit} className="flex flex-col h-full">
                            ...
                            <div className="flex flex-col items-end">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    type="submit"
                                    className="bg-[#EB5500] hover:bg-[#D44D00] cursor-pointer text-white text-[15px] font-semibold px-10 py-3.5 rounded-lg transition-colors shadow-lg shadow-orange-500/30 min-w-[200px]"
                                >
                                    Send Message
                                </motion.button>
                            </div>
