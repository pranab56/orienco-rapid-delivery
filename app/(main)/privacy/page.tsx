...
import { useGetPrivacyPolicyQuery } from '@/features/policy/policyApi';
        ...
        <div className="relative w-full h-[400px] md:h-[600px] rounded-b-xl overflow-hidden shrink-0">
          ...
          <div className="absolute inset-0 p-8 md:p-24 flex flex-col justify-end pb-16 md:pb-24">
            <motion.h1
              ...
              className="text-white font-medium text-4xl sm:text-5xl md:text-[4rem] leading-[1.1] tracking-normal max-w-[1200px]"
            >
              Understand Our<br className="hidden md:block" /> Privacy Policy<br className="hidden md:block" /> Completely.
            </motion.h1>
          </div>
        </div>
      </div>
